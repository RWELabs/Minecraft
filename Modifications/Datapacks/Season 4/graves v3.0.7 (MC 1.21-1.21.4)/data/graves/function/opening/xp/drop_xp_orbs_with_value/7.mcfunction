execute unless score $xp_points graves.dummy matches 7.. run return fail
data modify storage graves:main opening.xp_orb.Value set value 7s
...
scoreboard players remove $xp_points graves.dummy 7
function graves:opening/xp/drop_xp_orbs_with_value/7