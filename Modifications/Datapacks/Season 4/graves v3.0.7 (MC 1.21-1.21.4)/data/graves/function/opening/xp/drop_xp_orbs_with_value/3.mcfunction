execute unless score $xp_points graves.dummy matches 3.. run return fail
data modify storage graves:main opening.xp_orb.Value set value 3s
...
scoreboard players remove $xp_points graves.dummy 3
function graves:opening/xp/drop_xp_orbs_with_value/3