execute unless score $xp_points graves.dummy matches 73.. run return fail
data modify storage graves:main opening.xp_orb.Value set value 73s
...
scoreboard players remove $xp_points graves.dummy 73
function graves:opening/xp/drop_xp_orbs_with_value/73